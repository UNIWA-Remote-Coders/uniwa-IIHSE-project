<?php
  ...
  // log out current user by unsetting session
  ...
  // empty the cart if you have paid the products
  ...
  if(isset($_SESSION['logged_in'])) {
    ...
    // update the current order id after payment page
...
<html lang="en">
  ...
  <body>
      ...
      <div class="row container mx-auto">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <form id="account-form" method="POST" action="account.php">
            ...
            <!-- Show the confirm and error messages -->
            <div class="form-group">
              <p id="error-msg">
                <?php 
                  if(isset($_GET['error'])) { 
    ...
    <!-- Create a Table with current user's orders and a button in every order for more details-->
