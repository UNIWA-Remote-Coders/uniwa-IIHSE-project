...
<html lang="en">
    ...
    <body>
        ...
        <section id="allproducts" class="my-5 pb-5">
            ...
            <div>
                ...
                <nav class="page-nav" area-lable="page navigation example">
                    <ul class="pagination mt-5">
                        <li class="page-item"><a class="page-link" id="prev_product" href="products.php?products_page=1#" onclick="goPreviousPage(this)">Previous</a></li>
                        ...
                        <li class="page-item"><a class="page-link" href="products.php?products_page=5">5</a></li>
                        <li class="page-item"><a class="page-link" href="products.php?products_page=6">6</a></li>
                        <li class="page-item"><a class="page-link" id="next_product" href="products.php?products_page=6#" onclick="goNextPage(this)">Next</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <!-- call a query to find all products from db -->
